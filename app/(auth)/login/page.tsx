...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect to welcome-back screen to give user options
  ...
  return (
    <div className="min-h-screen bg-pathly-bg text-pathly-primary flex items-center justify-center p-6 selection:bg-pathly-lavender">
      <div className="w-full max-w-6xl flex flex-col md:flex-row bg-white rounded-[3rem] overflow-hidden shadow-2xl border border-pathly-primary/10 min-h-[700px]">
        
        {/* Left Side - Story / Illustration */}
        <div className="hidden md:flex flex-1 bg-pathly-lavender p-12 flex-col justify-between relative overflow-hidden">
          <div className="absolute top-0 left-0 w-full h-full bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] opacity-10 mix-blend-overlay"></div>
          <div className="z-10">
            <Link href="/" className="font-black text-2xl tracking-tighter flex items-center gap-2 mb-16">
              pathly.
            ...
            <p className="text-xl font-medium opacity-80 max-w-md">
              Pick up right where you left off. Your career roadmap is waiting for you.
            </p>
          </div>
          ...
          <div className="absolute top-1/4 -left-20 w-64 h-64 bg-pathly-peach rounded-full blur-3xl opacity-60"></div>
        </div>

        {/* Right Side - Form */}
        <div className="flex-1 p-12 md:p-20 flex flex-col justify-center bg-white relative z-10">
          <div className="max-w-md w-full mx-auto">
            <h2 className="text-4xl font-black mb-8 md:hidden">Welcome Back</h2>
            ...
            <div className="space-y-4 mb-8">
              ...
              <Button 
                variant="outline" 
                onClick={() => signIn("github", { callbackUrl: "/welcome-back" })}
                className="w-full rounded-2xl h-14 text-lg font-bold border-2 border-pathly-primary/10 hover:bg-pathly-primary/5 flex items-center justify-center gap-3"
              >
            ...
            <div className="relative mb-8">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-white text-pathly-primary/50 font-bold uppercase tracking-wider">Or login with email</span>
              </div>
            </div>
            ...
            <form className="space-y-4" onSubmit={handleSubmit}>
              ...
              <div className="space-y-2">
                <div className="flex justify-between items-center">
                  ...
                  <Link href="#" className="text-sm font-bold opacity-70 hover:opacity-100">Forgot?</Link>
                </div>
                <Input 
                  id="password" 
                  type="password" 
            ...
            <p className="text-center mt-8 font-medium text-pathly-primary/70">
              Don't have an account? <Link href="/signup" className="font-bold text-pathly-primary underline underline-offset-4">Sign up</Link>
            </p>
          </div>
        </div>
      </div>
